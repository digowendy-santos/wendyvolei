...
export function Header({ currentDate, onDateChange, onReset, hasTeams }: HeaderProps) {
  return (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-extrabold tracking-tight text-foreground">
              Arena <span className="text-primary">Beach Volley</span>
            </h1>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          {hasTeams && (
            <button
              onClick={() => { if (confirm('Resetar todos os dados do dia?')) onReset(); }}
